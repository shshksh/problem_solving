...
public class BOJ2261 {
    ...
    private static long closestDistance(int[][] position, int start, int end) {
        ...
        distance = Math.min(distance, boundaryDistance(position, start, end, boundary, distance));

        return distance;
    }

    private static long boundaryDistance(int[][] position, int start, int end, int boundary, long distance) {
