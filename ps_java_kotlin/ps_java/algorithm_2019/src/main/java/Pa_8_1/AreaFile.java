...
public class AreaFile {
    ...
    private void addToMap() throws FileNotFoundException {
        String path = "algorithm/src/algorithm.algorithm_2019/res/" + "alabama.txt";
    ...
    private void connectEdges() throws CloneNotSupportedException, FileNotFoundException {
        String path = "algorithm/src/algorithm.algorithm_2019/res/" + "roadList2.txt";
        File file = new File(path);
    ...
    private void print() throws IOException {
        File file = new File("algorithm/src/algorithm.algorithm_2019/resource/mst.txt");
        if (!file.exists())
            file.createNewFile();
